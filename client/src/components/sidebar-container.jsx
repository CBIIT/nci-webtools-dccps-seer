...
export function SidebarContainer({ collapsed = false, onCollapsed = () => {}, children = [], className = "" }) {
  const toggleProps = {
  ...
  //   "bi set-absolute",
  //   collapsed ? " bi-caret-right-fill" : " bi-caret-left-fill"
  // )}
  // style={{
  //   position: "absolute",
  //   left: "-10px",
  ...
  // data-toggle="tooltip"
  // title={
  //   collapsed ? "Show Configuration Panel" : "Hide Configuration Panel"
  // }
  // />
