              ...
              <div className="mb-4">
                ...
                {useRelaxModel && (
                  <Form.Group>
                    ...
                    <Form.Text>
                      The cut-point is the time after diagnosis that splits data into two groups. Cluster 1 includes
                      years 1 to the cut-point. Separate JPSurv models are applied to each cluster.
                    </Form.Text>
                  </Form.Group>
                )}
              </div>
